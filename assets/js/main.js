...
(function() {
  ...
  darkStyle.innerHTML = `
    ...
    /* General card and content box overrides */
    body.dark-mode .card,
    ...
    body.dark-mode [style*="background:#fff"],
    body.dark-mode [style*="background: #f4f4f0"],
    body.dark-mode [style*="background:#f4f4f0"] {
    ...
    /* Keep highlight sections and accent badges readable in dark mode */
    body.dark-mode .card.accent-cyan,
    body.dark-mode .card[style*="background: var(--accent-cyan)"],
    body.dark-mode .card[style*="background:var(--accent-cyan)"] {
    ...
    body.dark-mode .card.accent-magenta,
    body.dark-mode .card[style*="background: var(--accent-magenta)"],
    body.dark-mode .card[style*="background:var(--accent-magenta)"] {
    ...
    body.dark-mode .card.accent-purple,
    body.dark-mode .card[style*="background: var(--accent-purple)"],
    body.dark-mode .card[style*="background:var(--accent-purple)"] {
    ...
    /* Heading/text overrides for hardcoded black text */
    body.dark-mode h2[style*="color: #000"],
    body.dark-mode h2[style*="color:#000"],
    body.dark-mode h3[style*="color: #000"],
    body.dark-mode h3[style*="color:#000"],
    body.dark-mode h4[style*="color: #000"],
    body.dark-mode h4[style*="color:#000"],
    body.dark-mode p[style*="color: #000"],
    body.dark-mode p[style*="color:#000"],
    body.dark-mode span[style*="color: #000"],
    body.dark-mode span[style*="color:#000"],
    body.dark-mode label[style*="color: #000"],
    body.dark-mode label[style*="color:#000"] {
      color: #fff !important;
    }
    ...
    /* Navigation styling in dark mode */
    body.dark-mode .nav {
    ...
    body.dark-mode .btn-primary { 
      background: var(--accent-magenta) !important; /* Standout CTA */
      color: #fff !important;
    }
